...
public class AppServiceAuthRemoteAuthenticatorViewCore<TAuthenticationState> :
    ...
    where TAuthenticationState : RemoteAuthenticationState
{
    ...
    [Inject] IRemoteAuthenticationService<TAuthenticationState> AuthenticationService { get; set; } = null!;
    ...
    {
        if (state?.ReturnUrl is not null)
        {
...
public class AppServiceAuthRemoteAuthenticationContext<TAuthenticationState> :
    RemoteAuthenticationContext<TAuthenticationState>
    where TAuthenticationState : RemoteAuthenticationState
{
